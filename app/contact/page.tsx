                ...
                <CardContent className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <a href="mailto:contact@rouge-cardinal.fr" className="text-muted-foreground hover:text-primary">
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <a href="mailto:presse@rouge-cardinal.fr" className="text-muted-foreground hover:text-primary text-sm">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <a href="mailto:billetterie@rouge-cardinal.fr" className="text-muted-foreground hover:text-primary text-sm">
